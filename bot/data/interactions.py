...
INTERACTION_DEFINITIONS: tuple[InteractionDefinition, ...] = (
    ...
    ), (), "anime high five", "High Five Back", "highfive"),
    ...
    ), (), "anime handhold", "Handhold Back", "handhold"),
